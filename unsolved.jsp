...
<section id="studies_section">
    ...
    <table id="your_studies_table" >
        ...
        <% 
            ...
            List<Defect> defectRecords = DefectDB.getAllPendingDefects();
       ...
       <td><form action="<c:url value='/DefectController/solved'/>" method="post">
           <input type="hidden" name   ="defectCode" value="<%=defectRecord.getId()%>">
                    <button type="submit" id="btn">Solve it</button></form></td>
        </tr>
